...
const HUMAN_NAMES_PATH: String = "res://game/singleton_utilities/procedural_generation/human_names.txt"
const HUMAN_LINES_PATH: String = "res://game/singleton_utilities/procedural_generation/human_dialogue.txt"
